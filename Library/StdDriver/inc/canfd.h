...
#define CANFD_RXSS_RX                 (0 << CANFD_STSEL_RXSS_Pos)  /*!< CAN Rx Signal Selection - from CAN_Rx pin */
#define CANFD_RXSS_ACMP0              (1 << CANFD_STSEL_RXSS_Pos)  /*!< CAN Rx Signal Selection - from ACMP0 output */
#define CANFD_RXSS_ACMP1              (2 << CANFD_STSEL_RXSS_Pos)  /*!< CAN Rx Signal Selection - from ACMP1 output */

#define CANFD_TX_L0_LOW_L1_HIGH       0x0ul  /*!< CAN_Tx Logical 0: output low; CAN_Tx Logical 1: output high */
#define CANFD_TX_L0_HIGH_L1_LOW       0x1ul  /*!< CAN_Tx Logical 0: output high; CAN_Tx Logical 1: output low */
#define CANFD_TX_L0_LOW_L1_FLOATING   0x2ul  /*!< CAN_Tx Logical 0: output low; CAN_Tx Logical 1: floating */
#define CANFD_TX_L0_FLOATING_L1_LOW   0x3ul  /*!< CAN_Tx Logical 0: floating; CAN_Tx Logical 1: output low */
#define CANFD_TX_L0_HIGH_L1_FLOATING  0x4ul  /*!< CAN_Tx Logical 0: output high; CAN_Tx Logical 1: floating */
#define CANFD_TX_L0_FLOATING_L1_HIGH  0x5ul  /*!< CAN_Tx Logical 0: floating; CAN_Tx Logical 1: output high */
...
/**
 *    @brief        Set CAN Rx Signal Selection
 *
 *    @param[in]    canfd    The pointer of the specified CANFD module
 *    @param[in]    rxss     CAN Rx signal selection. Possible options are
 *                           - \ref CANFD_RXSS_RX
 *                           - \ref CANFD_RXSS_ACMP0
 *                           - \ref CANFD_RXSS_ACMP1
 *
 *    @return       None.
 *
 *    @details      This macro sets RXSS to select Rx signal source.
 *    \hideinitializer
 */
#define CANFD_SET_RXSS(canfd, rxss)    ((canfd)->STSEL = ((canfd)->STSEL & (~CANFD_STSEL_RXSS_Msk)) | (rxss))

/**
 *    @brief        Set CAN TxL Signal Type
 *
 *    @param[in]    canfd    The pointer of the specified CANFD module
 *    @param[in]    txls     CAN TxL signal type. Possible options are
 *                           - \ref CANFD_TX_L0_LOW_L1_HIGH
 *                           - \ref CANFD_TX_L0_HIGH_L1_LOW
 *                           - \ref CANFD_TX_L0_LOW_L1_FLOATING
 *                           - \ref CANFD_TX_L0_FLOATING_L1_LOW
 *                           - \ref CANFD_TX_L0_HIGH_L1_FLOATING
 *                           - \ref CANFD_TX_L0_FLOATING_L1_HIGH
 *
 *    @return       None.
 *
 *    @details      This macro sets TXLS to select TxL signal type.
 *    \hideinitializer
 */
#define CANFD_SET_TXLS(canfd, txls)    ((canfd)->STSEL = ((canfd)->STSEL & (~CANFD_STSEL_TXLS_Msk)) | (txls << CANFD_STSEL_TXLS_Pos))

/**
 *    @brief        Set CAN TxH Signal Type
 *
 *    @param[in]    canfd    The pointer of the specified CANFD module
 *    @param[in]    txhs     CAN TxH signal type. Possible options are
 *                           - \ref CANFD_TX_L0_LOW_L1_HIGH
 *                           - \ref CANFD_TX_L0_HIGH_L1_LOW
 *                           - \ref CANFD_TX_L0_LOW_L1_FLOATING
 *                           - \ref CANFD_TX_L0_FLOATING_L1_LOW
 ...
 *    @return       None.
 *
 *    @details      This macro sets TXHS to select TxH signal type.
 *    \hideinitializer
 */
#define CANFD_SET_TXHS(canfd, txhs)    ((canfd)->STSEL = ((canfd)->STSEL & (~CANFD_STSEL_TXHS_Msk)) | (txhs << CANFD_STSEL_TXHS_Pos))
...
typedef struct
{
    ...
    uint32_t          u32Id;                        /*! Standard ID (11-bits) or Extended ID (29-bits) */
...
extern void CANFD_InitRxFifo(CANFD_T *canfd, uint32_t u32RxFifoNum, CANFD_RAM_PART_T *psRamConfig, CANFD_ELEM_SIZE_T *psElemSize, uint32_t u32FifoWM, E_CANFD_DATA_FIELD_SIZE eFifoSize);
extern void CANFD_InitRxDBuf(CANFD_T *canfd, CANFD_RAM_PART_T *psRamConfig, CANFD_ELEM_SIZE_T *psElemSize, E_CANFD_DATA_FIELD_SIZE eRxBufSize);
extern void CANFD_InitTxDBuf(CANFD_T *canfd, CANFD_RAM_PART_T *psRamConfig, CANFD_ELEM_SIZE_T *psElemSize, E_CANFD_DATA_FIELD_SIZE eTxBufSize);
extern void CANFD_InitTxEvntFifo(CANFD_T *canfd, CANFD_RAM_PART_T *psRamConfig, CANFD_ELEM_SIZE_T *psElemSize, uint32_t u32FifoWaterLvl);
extern void CANFD_ConfigSIDFC(CANFD_T *canfd, CANFD_RAM_PART_T *psRamConfig, CANFD_ELEM_SIZE_T *psElemSize);
extern void CANFD_ConfigXIDFC(CANFD_T *canfd, CANFD_RAM_PART_T *psRamConfig, CANFD_ELEM_SIZE_T *psElemSize);
