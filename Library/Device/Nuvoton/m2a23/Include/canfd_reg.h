...
typedef struct
{
    ...
    /**
     * @var CANFD_T::DBTP
     * Offset: 0x0C  Data Bit Timing & Prescaler Register (P*)
     * ---------------------------------------------------------------------------------------------------
     ...
     * @var CANFD_T::TEST
     * Offset: 0x10  Test Register (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[4]     |LBCK      |Loop Back Mode
     * |        |          |0 = Reset value, Loop Back Mode Disabled.
     * |        |          |1 = Loop Back Mode Enabled (refer to TEST Mode in Operation Mode section).
     ...
     * @var CANFD_T::CCCR
     * Offset: 0x18  CC Control Register (Pp*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::NBTP
     * Offset: 0x1C  Nominal Bit Timing & Prescaler Register (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |tSJW = (NSJW + 1) x tq.
     * @var CANFD_T::TSCC
     * Offset: 0x20  Timestamp Counter Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |10 = 2nd timestamp counter value used (clock source comes from CCLK).
     * |        |          |11 = Same as "00".
     ...
     * |        |          |The actual interpretation by the hardware of this value is such that one more than the value programmed here is used.
     * @var CANFD_T::TSCV
     * Offset: 0x24  Timestamp Counter Value (C*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::TOCC
     * Offset: 0x28  Timeout Counter Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::TOCV
     * Offset: 0x2C  Timeout Counter Value (C*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Start and reset/restart conditions are configured via TOS (CANFD_TOCC[2:1]).
     * @var CANFD_T::ECR
     * Offset: 0x40  Error Counter Register (X*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::PSR
     * Offset: 0x44  Protocol Status Register (XS*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::TDCR
     * Offset: 0x48  Transmitter Delay Compensation Register (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::GFC
     * Offset: 0x80  Global Filter Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |11 = Reject.
     * @var CANFD_T::SIDFC
     * Offset: 0x84  Standard ID Filter Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::XIDFC
     * Offset: 0x88  Extended ID Filter Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::XIDAM
     * Offset: 0x90  Extended ID AND Mask (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Range is 0 to LSS (CANFD_SIDFC[23:16]) - 1 or LSE (CANFD_XIDFC[22:16]) u2013 1
     * |[15]    |FLST      |Filter List
     ...
     * |        |          |1 = Rx Buffer updated from new message.
     * @var CANFD_T::RXF0C
     * Offset: 0xA0  Rx FIFO 0 Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |When RF0L is reset, this bit is also reset
     * |        |          |0 = No Rx FIFO 0 message lost.
     * |        |          |1 = Rx FIFO 0 message lost, also set after write attempt to Rx FIFO 0 of size zero.
     ...
     * @var CANFD_T::RXBC
     * Offset: 0xAC  Rx Buffer Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::RXF1C
     * Offset: 0xB0  Rx FIFO 1 Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |[21:16] |F1PI      |Rx FIFO 1 Put Index
     ...
     * |        |          |When RF1L is reset, this bit is also reset
     * |        |          |0 = No Rx FIFO 1 message lost.
     * |        |          |1 = Rx FIFO 1 message lost, also set after write attempt to Rx FIFO 1 of size zero.
     ...
     * @var CANFD_T::RXESC
     * Offset: 0xBC  Rx Buffer / FIFO Element Size Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |111 = 64 byte data field.
     * @var CANFD_T::TXBC
     * Offset: 0xC0  Tx Buffer Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::TXESC
     * Offset: 0xC8  Tx Buffer Element Size Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |TRPn      |Transmission Request Pending
     * |        |          |Each Tx Buffer has its own Transmission Request Pending bit. The bits are set via register CANFD_TXBAR. The bits are reset after a requested transmission has completed or has been cancelled via register CANFD_TXBCR.
     * |        |          |CANFD_TXBRP bits are set only for those Tx Buffers configured via CANFD_TXBC
     * |        |          |After a CANFD_TXBRP bit has been set, a Tx scan (refer to section 1.1.5.5, Tx Handling) is started to check for the pending Tx request with the highest priority (Tx Buffer with lowest Message ID).
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |ARn       |Add Request
     * |        |          |Each Tx Buffer has its own Add Request bit Writing a 1 will set the corresponding Add Request bit; writing a 0 has no impact This enables the Host to set transmission requests for multiple Tx Buffers with one write to CANFD_TXBAR.
     * |        |          |CANFD_TXBAR bits are set only for those Tx Buffers configured via CANFD_TXBC When no Tx scan is running, the bits are reset immediately, else the bits remain set until the Tx scan process has completed.
     ...
     * @var CANFD_T::TXEFC
     * Offset: 0xF0  Tx Event FIFO Configuration (P*)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var CANFD_T::STSEL
     * Offset: 0xFC  Tx Rx Signal Type Selection Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |10 = from ACMP1 output
     * |        |          |11 = Reserved. 
     */
    __I  uint32_t RESERVE0[3];
    __IO uint32_t DBTP;                  /*!< [0x000c] Data Bit Timing & Prescaler Register (P*)                        */
    __IO uint32_t TEST;                  /*!< [0x0010] Test Register (P*)                                               */
    __IO uint32_t RWD;                   /*!< [0x0014] RAM Watchdog (P*)                                                */
    __IO uint32_t CCCR;                  /*!< [0x0018] CC Control Register (Pp*)                                        */
    __IO uint32_t NBTP;                  /*!< [0x001c] Nominal Bit Timing & Prescaler Register (P*)                     */
    __IO uint32_t TSCC;                  /*!< [0x0020] Timestamp Counter Configuration (P*)                             */
    __IO uint32_t TSCV;                  /*!< [0x0024] Timestamp Counter Value (C*)                                     */
    __IO uint32_t TOCC;                  /*!< [0x0028] Timeout Counter Configuration (P*)                               */
    __IO uint32_t TOCV;                  /*!< [0x002c] Timeout Counter Value (C*)                                       */
    __I  uint32_t RESERVE1[4];
    __I  uint32_t ECR;                   /*!< [0x0040] Error Counter Register (X*)                                      */
    __I  uint32_t PSR;                   /*!< [0x0044] Protocol Status Register (XS*)                                   */
    __IO uint32_t TDCR;                  /*!< [0x0048] Transmitter Delay Compensation Register (P*)                     */
    ...
    __IO uint32_t GFC;                   /*!< [0x0080] Global Filter Configuration (P*)                                 */
    __IO uint32_t SIDFC;                 /*!< [0x0084] Standard ID Filter Configuration (P*)                            */
    __IO uint32_t XIDFC;                 /*!< [0x0088] Extended ID Filter Configuration (P*)                            */
    __I  uint32_t RESERVE4[1];
    __IO uint32_t XIDAM;                 /*!< [0x0090] Extended ID AND Mask (P*)                                        */
    ...
    __IO uint32_t RXF0C;                 /*!< [0x00a0] Rx FIFO 0 Configuration (P*)                                     */
    __IO uint32_t RXF0S;                 /*!< [0x00a4] Rx FIFO 0 Status                                                 */
    __IO uint32_t RXF0A;                 /*!< [0x00a8] Rx FIFO 0 Acknowledge                                            */
    __IO uint32_t RXBC;                  /*!< [0x00ac] Rx Buffer Configuration (P*)                                     */
    __IO uint32_t RXF1C;                 /*!< [0x00b0] Rx FIFO 1 Configuration (P*)                                     */
    __IO uint32_t RXF1S;                 /*!< [0x00b4] Rx FIFO 1 Status                                                 */
    __IO uint32_t RXF1A;                 /*!< [0x00b8] Rx FIFO 1 Acknowledge                                            */
    __IO uint32_t RXESC;                 /*!< [0x00bc] Rx Buffer / FIFO Element Size Configuration (P*)                 */
    __IO uint32_t TXBC;                  /*!< [0x00c0] Tx Buffer Configuration (P*)                                     */
    __IO uint32_t TXFQS;                 /*!< [0x00c4] Tx FIFO/Queue Status                                             */
    __IO uint32_t TXESC;                 /*!< [0x00c8] Tx Buffer Element Size Configuration (P*)                        */
    ...
    __IO uint32_t TXEFC;                 /*!< [0x00f0] Tx Event FIFO Configuration (P*)                                 */
    __IO uint32_t TXEFS;                 /*!< [0x00f4] Tx Event FIFO Status                                             */
    __IO uint32_t TXEFA;                 /*!< [0x00f8] Tx Event FIFO Acknowledge                                        */
    __IO uint32_t STSEL;                 /*!< [0x00fc] Tx Rx Signal Type Selection Register                             */
...
#define CANFD_STSEL_TXHS_Pos             (0)                                               /*!< CANFD_T::STSEL: TXHS Position          */
#define CANFD_STSEL_TXHS_Msk             (0x7ul << CANFD_STSEL_TXHS_Pos)                   /*!< CANFD_T::STSEL: TXHS Mask              */

#define CANFD_STSEL_TXLS_Pos             (4)                                               /*!< CANFD_T::STSEL: TXLS Position          */
#define CANFD_STSEL_TXLS_Msk             (0x7ul << CANFD_STSEL_TXLS_Pos)                   /*!< CANFD_T::STSEL: TXLS Mask              */
