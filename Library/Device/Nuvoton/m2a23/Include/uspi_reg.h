...
/*---------------------- Universal Serial Control Interface Controller - SPI Mode -------------------------*/
/**
...
typedef struct
{
     ...
     * |        |          |0 = Master mode.
     * |        |          |1 = Slave mode.
     * |[1]     |SLV3WIRE  |Slave 3-wire Mode Selection for Slave Only
     ...
     * |[2]     |SS        |Slave Select Control for Master Only
     ...
     * |[3]     |AUTOSS    |Automatic Slave Select Function Enable for Master Only
     ...
     * |        |          |00 = MODE0
     * |        |          |The idle state of SPI clock is low level
     ...
     * |        |          |10 = MODE2
     * |        |          |The idle state of SPI clock is high level
     * |        |          |Data is transmitted with rising edge and received with falling edge.
     * |        |          |11 = MODE3
     * |        |          |The idle state of SPI clock is high level
     * |        |          |Data is transmitted with falling edge and received with rising edge.
     * |[11:8]  |SUSPITV   |Suspend Interval for Master Only
     ...
     * |[25:16] |SLVTOCNT  |Slave Mode Time-out Period for Slave Only
     ...
     * |[28]    |TXUDRPOL  |Transmit Under-run Data Polarity for Slave Only
     ...
     * |        |          |0 = Slave time-out interrupt Disabled.
     * |        |          |1 = Slave time-out interrupt Enabled.
