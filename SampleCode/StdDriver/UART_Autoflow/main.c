...
void AutoFlow_FunctionRxTest(void)
{
    ...
    /* Set RTS Trigger Level as 6 bytes */
    UART1->FIFO = (UART1->FIFO & (~UART_FIFO_RTSTRGLV_Msk)) | UART_FIFO_RTSTRGLV_6BYTES;

    /* Set RX Trigger Level as 6 bytes */
    UART1->FIFO = (UART1->FIFO & (~UART_FIFO_RFITL_Msk)) | UART_FIFO_RFITL_6BYTES;
